    ...
    <header class="page-header header container-fluid">
        ...
        <div class="description">
            <div class="container">
                ...
                <div class="image-link">
                    <a href="ViewReservation.jsp?id=<%= request.getParameter("id") %>">
                        <img src="image/reserve.jpg" alt="View Reservation" />
                    </a>
                    <h2>View Reservation</h2>
                </div>
                <div class="image-link">
                    <a href="ViewHistory.jsp?id=<%= request.getParameter("id") %>">
                        <img src="image/history.jpg" alt="View History" />
                    </a>
                    <h2>View History</h2>
                </div>
            </div>
