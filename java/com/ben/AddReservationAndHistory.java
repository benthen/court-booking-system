 ...
 */
@Stateless
public class AddReservationAndHistory {
	String id;
	String number;
	String college;
	String court;
     ...
     * Default constructor. 
     */
    public AddReservationAndHistory(String id, String number, String college, String court, String period) {
    	this.id = id;
        this.number = number;
    ...
    public void addReservationAndHistory(Connection con) throws SQLException {
